...
import com.olegpash.web_lab2.dao.UserJsonDAO;
import com.olegpash.web_lab2.entity.User;
import com.olegpash.web_lab2.model.UserDAO;
import com.olegpash.web_lab2.utils.Encryptor;
...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        userDAO.saveUser(new User(login, password, System.nanoTime() +  TimeUnit.SECONDS.toNanos(999999999), sign));
