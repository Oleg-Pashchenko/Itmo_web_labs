package com.olegpash.web_lab2.servlet;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.olegpash.web_lab2.exception.ValidationException;
import com.olegpash.web_lab2.table.Coordinates;
import com.olegpash.web_lab2.table.ResultRow;
import com.olegpash.web_lab2.table.TableHistoryBean;
import com.olegpash.web_lab2.utils.HitChecker;
import com.olegpash.web_lab2.utils.Validator;
...
public class AreaCheckServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            coordinates = new Coordinates(Double.parseDouble(xPar), Double.parseDouble(yPar), Float.parseFloat(rPar));
